                  ...
                  <tr key={index}>
                    ...
                    <td>
                      <div className="flex items-center justify-end ">
                        {paidStatus?.free == 1 ? (
                          paidStatus?.free == 1 && paidStatus.pro == 1 ? (
                            <button className="bg-[#2F93DF] px-2 py-1 lg:px-3 lg:py-2 text-white ">
                              Free
                            </button>
                          ) : (
                            <button className="bg-[#2F93DF] px-2 py-1 lg:px-3 lg:py-2 text-white  rounded-tr-xl ">
                              Free
                            </button>
                          )
                        ) : (
                        ...
                        {paidStatus?.pro == 1 && (
                          <button className="bg-[#1AB17A] px-2 py-1 lg:px-3 lg:py-2 text-white  rounded-tr-xl ">
                            Pro
                          </button>
                        )}
                      </div>
