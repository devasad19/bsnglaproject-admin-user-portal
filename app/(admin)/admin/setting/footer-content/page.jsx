...
import FooterContentSkeleton from "@/app/(admin)/component/FooterContentSkeleton/FooterContentSkeleton";
...
const Home = () => {
    ...
    getFooterRightData()
      .then((response) => {
        setRightForm({
          ...
          social: response?.social_icons
            ? JSON.parse(response?.social_icons)
            : [
                {
                  icon: "",
                  link: "",
      ...
      .catch((err) => console.log("3rd err: ", err))
  ...
  const HandleUpdate1 = async (e) => {
    ...
    const response = await upDateFooterLeft(form, leftForm.id)
      .catch((err) => {
  ...
  const HandleUpdate2 = async (e) => {
    ...
    const response = await updateFooterMiddle(middleForm.id, form)
      .catch((err) => {
  ...
  const HandleUpdate3 = async (e) => {
    ...
    const response = await updateFooterRight(form)
      .catch((err) => console.log("3rd err: ", err))
      .finally(() => setLoading(false));
        ...
        <div>
          <div className="flex gap-2 pb-5">
            ...
            <button
              onClick={() => setTab(3)}
              className={`px-4 py-2 rounded text-white ${
                tab == 3 ? "bg-primary" : "bg-primary/50"
              }`}
            >
              Right Column
            </button>
            ...
            <div>
              <form onSubmit={HandleUpdate1} className="flex flex-col gap-2">
                <fieldset className="flex flex-col border border-gray-400 rounded px-2">
                  ...
                  <input
                    onChange={(e) =>
                      setLeftForm({ ...leftForm, title: e.target.value })
                    }
                ...
                <fieldset className="flex flex-col border border-gray-400 rounded px-2">
                  ...
                  <textarea
                    rows={5}
                    onChange={(e) =>
                      setLeftForm({ ...leftForm, description: e.target.value })
                    }
                ...
                <fieldset className="flex flex-col border border-gray-400 rounded px-2">
                  ...
                  <textarea
                    onChange={(e) =>
                      setLeftForm({ ...leftForm, copyText: e.target.value })
                    }
                    value={leftForm.copyText}
                    name="copyText"
                    id="copyText"
                    className="w-full outline-none text-14 py-1"
                    required
            ...
            <div>
              <form onSubmit={HandleUpdate2} className="flex flex-col gap-2">
                <fieldset className="flex flex-col border border-gray-400 rounded px-2">
                  ...
                  <input
                    onChange={(e) =>
                      setMiddleForm({ ...middleForm, title: e.target.value })
                    }
                    value={middleForm.title}
                    type="text"
                    id="title2"
                    placeholder="Enter title"
                    className="w-full outline-none text-14 py-1"
                ...
                <div className="bg-slate-100 rounded flex justify-between items-center p-2 mb-5">
                  ...
                  <button
                    onClick={() =>
                      setMiddleForm({
                        ...middleForm,
                        links: [...middleForm.links, { label: "", link: "" }],
                      })
                    }
                    ...
                    <div key={index} className="w-full flex gap-2">
                      <div className="border border-gray-400 rounded p-2 space-y-3 w-full">
                        <div className="grid grid-cols-12">
                          <p className="text-14 after:content-['_*'] after:text-red-500">
                            Label:
                          </p>
                          <input
                            onChange={(e) =>
                              setMiddleForm({
                                ...middleForm,
                                links: middleForm.links.map((link, i) =>
                                  i == index
                            ...
                            className="col-span-11 border border-gray-400 rounded outline-none p-1"
                            required
                          />
                        </div>
                        <div className="grid grid-cols-12">
            ...
            <div>
              <form onSubmit={HandleUpdate3} className="flex flex-col gap-2">
                <fieldset className="flex flex-col border border-gray-400 rounded px-2">
                  ...
                  <input
                    onChange={(e) =>
                      setRightForm({ ...rightForm, title: e.target.value })
                    }
                ...
                <fieldset className="flex flex-col border border-gray-400 rounded px-2">
                  ...
                  <textarea
                    onChange={(e) =>
                      setRightForm({ ...rightForm, address: e.target.value })
                    }
                    value={rightForm.address}
                    className="w-full outline-none text-14 py-1"
                    name="address"
                    id="address"
                ...
                <fieldset className="flex flex-col border border-gray-400 rounded px-2 pb-2">
                  ...
                  {typeof rightForm?.addressIcon == "object" && (
                    <img
                      src={URL.createObjectURL(rightForm.addressIcon)}
                      className="w-32 h-32 object-cover"
                    />
                  )}
                </fieldset>
                    ...
                    <div className="grow border border-gray-400 rounded p-2 space-y-3">
                      <div className="">
                        <div className="flex items-center gap-2 pb-2">
                          ...
                          <input
                            onChange={(e) =>
                              setRightForm({
                                ...rightForm,
                                contacts: rightForm.contacts.map((contact, i) =>
                                  i == index
                                    ? { ...contact, icon: e.target.files[0] }
                                    : contact
                                ),
                              })
                            }
                            ...
                            name="icon"
                            id="icon"
                            className="grow border border-gray-400 rounded outline-none p-1"
                          />
                        </div>
                        ...
                        {typeof contact.icon == "string" && (
                          <img
                            src={
                              process.env.NEXT_PUBLIC_IMAGE_URL + contact.icon
                            }
                            className="w-32 h-32 object-cover"
                          />
                        )}
                        ...
                        {typeof contact.icon == "object" && (
                          <img
                            src={URL.createObjectURL(contact.icon)}
                            className="w-32 h-32 object-cover"
                          />
                        )}
                      </div>
                    ...
                    <div>
                      <button
                        onClick={() =>
                          setRightForm({
                            ...rightForm,
                            contacts: rightForm.contacts.filter(
                              (contact, i) => i != index
                            ),
                          })
                        }
                ...
                <div className="bg-slate-100 rounded flex justify-between items-center p-2 mb-2">
                  ...
                  <button
                    onClick={() =>
                      setRightForm({
                        ...rightForm,
                        social: [...rightForm.social, { icon: "", link: "" }],
                      })
                    }
                    className="bg-primary p-1 rounded"
                  >
                    ...
                    <div className="grow border border-gray-400 rounded p-2 space-y-3">
                      <div>
                        <div className="w-full flex items-center gap-2">
                          ...
                          <input
                            onChange={(e) =>
                              setRightForm({
                                ...rightForm,
                                social: rightForm.social.map((link, i) =>
                                  i == index
                                    ? { ...link, icon: e.target.files[0] }
                                    : link
                                ),
                              })
                            }
                        ...
                        {typeof link.icon == "string" && (
                          <img
                            src={process.env.NEXT_PUBLIC_IMAGE_URL + link.icon}
                            className="w-32 h-32 object-cover"
                          />
                        )}
                    ...
                    <div>
                      <button
                        onClick={() =>
                          setRightForm({
                            ...rightForm,
                            social: rightForm.social.filter(
                              (link, i) => i != index
                            ),
                          })
                        }
