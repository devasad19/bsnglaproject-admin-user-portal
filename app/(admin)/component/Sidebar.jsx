  ...
  const toggleAccordionSub = (valueName1) => {
    setIsToggleOpen((prevIsToggleOpen) => {
      ...
      if (valueName1 === "userManagement") {
        return {
          userManagement: !prevIsToggleOpen.userManagement,
          setting: false,
          alc: false,
          accountsSettings: false,
          // Close the other accordion
            ...
            >
              <li
                className={` ${isOpen ? "hover:bg-primary" : ""} group ${
                  isOpen && pathname == "/admin" ? "bg-primary" : ""
                }`}
              >
                <Link
                  href={{
              ...
              {isOpen && (
                <NewAccordion isOpen={isToggleOpen.userManagement}>
              ...
              <li
                ...
                className={`${
                  ...
                  isOpen && pathname.includes("/admin/setting") && "bg-primary"
                } cursor-pointer ${
                  isOpen && isToggleOpen.setting
              ...
              <li
                className={`${isOpen ? "hover:bg-primary" : ""} group ${
                  isOpen && pathname == "/admin/user-feedbacks"
                    ? "bg-primary"
                    : ""
                }`}
              >
