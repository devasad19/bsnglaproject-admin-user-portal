    ...
    <section>
      ...
      <div className="flex flex-wrap gap-3">
        <Link
          href={"/admin/services"}
          shallow
          className="w-full md:w-1/2 xl:w-[24%]"
        >
          <div className="bg-blue-500 text-white rounded-lg shadow-lg">
            <div className="p-4 text-left text-24 font-bold">
              {data?.totalServices}
            </div>
        ...
        <Link
          href={"/admin/accounts-settings/purchase-services"}
          shallow
          className="w-full md:w-1/2 xl:w-[24%]"
        >
          <div className="bg-green-500 text-white rounded-lg shadow-lg">
            <div className="p-4 text-left text-24 font-bold">
              {data?.soldServices}
            </div>
        ...
        <Link
          href={"/admin/accounts-settings/active-purchase-services"}
          shallow
          className="w-full md:w-1/2 xl:w-[24%]"
        >
          <div className="bg-yellow-500 text-white rounded-lg shadow-lg">
            <div className="p-4 text-left text-24 font-bold">
              {data?.activeSoldServices}
            </div>
            <div className="p-4 flex items-center justify-between bg-yellow-600 rounded-b-lg">
              <p className="text-white text-sm font-medium underline">
                Active Sold Services{" "}
              </p>
              <div className="text-white">
                <svg
                  className="w-4 h-4"
        ...
        <Link
          ...
          className="w-full md:w-1/2 xl:w-[24%]"
        >
          <div className="bg-indigo-500 text-white rounded-lg shadow-lg">
            <div className="p-4 text-left text-24 font-bold">
              {data?.feedbacks}
            </div>
            ...
            <div className="p-4">
              ...
              <div className="flex flex-col lg:flex-row">
                <div className="lg:w-[40%] p-3">
                  <div
                    id="circleProgress6"
                    className="relative rounded-full bg-gray-100 p-4"
                  >
                    ...
                    {data?.visits?.map((item, index) => (
                      <li key={index} className="flex justify-between text-sm">
                        ...
                        <div className="w-[40%] text-right">
                          {item?.visits} ({" "}
                          {((item?.visits / data?.total_visits) * 100).toFixed(
                            2
                          )}{" "}
                          %)
                        </div>
